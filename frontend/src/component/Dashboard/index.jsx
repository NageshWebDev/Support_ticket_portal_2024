  ...
  return (
    <section className="min-h-full">
      <main className="flex flex-wrap gap-5">
        <div className="bg-gray-50 rounded-md shadow-md w-80 flex justify-center items-center gap-5 p-5">
          ...
          <div>
            ...
            <p className="text-stone-700 text-base font-medium">45</p>
          </div>
        </div>
        ...
        {progressBarDetails.map((detail) => (
          <NavLink
            ...
            className="bg-gray-50 rounded-md shadow-md w-80 flex justify-center items-center gap-5 p-5"
          >
            <CircularProgressbar
              className="size-20"
